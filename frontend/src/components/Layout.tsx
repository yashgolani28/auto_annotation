    ...
    <Link
      ...
      className={cx(
        ...
        active
          ...
          : "text-slate-800 hover:bg-blue-50 hover:text-blue-800 dark:text-slate-100 dark:hover:bg-blue-950/40 dark:hover:text-blue-200"
      )}
    >
      {label}
    </Link>
  ...
  return (
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-5 py-3 flex items-center justify-between gap-4">
          <Link to="/" className="flex items-center gap-3 min-w-0 hover:opacity-90 transition-opacity">
            ...
            <div className="min-w-0">
              <div className="font-semibold leading-tight truncate">MLOps</div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:block text-right">
              <div className="text-sm font-medium text-slate-800 dark:text-slate-100">{user?.name || "User"}</div>
      ...
      <div className="max-w-7xl mx-auto px-5 py-6">
        <div className="app-card p-5 md:p-6">{children}</div>
      </div>
    </div>
  )
}
